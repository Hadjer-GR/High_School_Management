...
<nav class="sidebar close">
    ...
    <section class="home hometextbool">
      ...
      <th>
        <input type="email" class="search-input" placeholder="email">
      </th>
       <th>
        <input type="date" class="search-input" placeholder="date naissonce">
      </th>
      <th>
        <input type="number" class="search-input" placeholder="Numero du couloir">
      </th>
      
    </tr>
                </thead>
                <tbody>
                     <c:forEach  var="listsecri"  items="${listsecri}"  >
                    <tr class="student">
                       
                        <td><c:out value="${listsecri.getFirst_name()}" /></span></td>
                        <td><c:out value="${listsecri.getLast_name() }" /></span></td>
                         
                        <td><c:out value="${listsecri. getEmail()}" /></span> </td>
                        <td><c:out value="${listsecri.getDate_birth() }" /></span></td>
                         <td><c:out value="${listsecri.getContact_number()}" /></span></td>
