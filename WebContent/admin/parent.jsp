...
<nav class="sidebar close">
    ...
    <section class="home hometextbool">
      ...
      <th>
        <input type="number" class="search-input" placeholder="Numero du téléphone">
      </th>
      
    </tr>
                </thead>
                <tbody>
                          <c:forEach  var="listparent"  items="${listparent}"  >
                    <tr class="student">
                       
                        <td></td>
                        <td></td>
                         
                        <td><c:out value="${listparent.getEmail()}" /></span> </td>
               
                         <td><c:out value="${listparent.getContact_number()}" /></span></td>
